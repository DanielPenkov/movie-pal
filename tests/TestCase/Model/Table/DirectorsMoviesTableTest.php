...
class DirectorsMoviesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('DirectorsMovies') ? [] : ['className' => 'App\Model\Table\DirectorsMoviesTable'];
        $this->DirectorsMovies = TableRegistry::get('DirectorsMovies', $config);
    }
